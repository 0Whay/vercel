...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-orange-500 to-red-600 text-white shadow-lg hover:shadow-orange-500/30 hover:-translate-y-0.5",
    secondary: "bg-white text-gray-800 shadow-md hover:bg-gray-50",
